...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authenticationProvider(new JwtAuthenticationProvider(jwtTokenFactory()));
        http.authenticationProvider(new RefreshTokenAuthenticationProvider(userDetailsService(), jwtTokenFactory()));
